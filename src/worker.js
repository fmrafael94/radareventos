...
const notFoundVariants = [
  { eyebrow: "404", heading: "Puxaram-lhe a ficha.", body: "Este evento ficou sem corrente.", cta: "Voltar ao alinhamento", image: "/brand/404/amplificador-normalizado.png?v=1", alt: "Amplificador mascote com o cabo desligado", en: { eyebrow:"404", heading:"Someone pulled the plug.", body:"This event ran out of power.", cta:"Back to the setlist", alt:"Amplifier mascot with an unplugged cable" } },
  ...
  { eyebrow: "404", heading: "A tour perdeu-se.", body: "Este evento fez um desvio a mais.", cta: "Traçar nova rota", image: "/brand/404/carrinha-normalizada.png?v=1", alt: "Carrinha de tour mascote num desvio", en: { eyebrow:"404", heading:"The tour got lost.", body:"This event took one detour too many.", cta:"Plot a new route", alt:"Tour van mascot taking a detour" } },
  { eyebrow: "404", heading: "O beat foi ao bar.", body: "E levou este evento com ele.", cta: "Ver quem toca a seguir", image: "/brand/404/bateria-normalizada.png?v=1", alt: "Bateria mascote num palco vazio", en: { eyebrow:"404", heading:"The beat went to the bar.", body:"It took this event along with it.", cta:"See who plays next", alt:"Drum kit mascot on an empty stage" } },
  { eyebrow: "404", heading: "A corda deu o berro.", body: "Este evento saiu do tom.", cta: "Afinar nova procura", image: "/brand/404/guitarra-normalizada.png?v=1", alt: "Guitarra mascote com uma corda partida", en: { eyebrow:"404", heading:"The string snapped.", body:"This event fell out of tune.", cta:"Tune a new search", alt:"Guitar mascot with a broken string" } }
];
