...
const notFoundVariants = [
  { eyebrow: "404 · Sem sinal", heading: "A banda saiu do palco.", body: "Este evento já não está na agenda. O cabo ficou, mas o concerto não.", cta: "Voltar ao alinhamento", image: "/brand/404/amplificador.png", alt: "Amplificador mascote com o cabo desligado", en: { eyebrow:"404 · No signal", heading:"The band has left the stage.", body:"This event is no longer listed. The cable stayed; the concert did not.", cta:"Back to the setlist", alt:"Amplifier mascot with an unplugged cable" } },
  { eyebrow: "404 · Fora da faixa", heading: "Perdemos o beat.", body: "Este evento saltou da playlist. Vamos pôr outra coisa a tocar.", cta: "Voltar à agenda", image: "/brand/404/vinil.png", alt: "Disco de vinil mascote à procura do beat", en: { eyebrow:"404 · Off track", heading:"We lost the beat.", body:"This event skipped the playlist. Let’s put something else on.", cta:"Back to the listings", alt:"Vinyl record mascot looking for the beat" } },
  { eyebrow: "404 · Desvio na estrada", heading: "O evento foi de tournée.", body: "Virou na saída errada e já não mora aqui.", cta: "Traçar nova rota", image: "/brand/404/carrinha.png", alt: "Carrinha de tournée mascote num desvio", en: { eyebrow:"404 · Tour detour", heading:"The event went on tour.", body:"It took the wrong exit and no longer lives here.", cta:"Plot a new route", alt:"Tour van mascot taking a detour" } },
  { eyebrow: "404 · Depois do encore", heading: "Silêncio no alinhamento.", body: "O palco ficou vazio. A agenda, felizmente, não.", cta: "Ver quem toca a seguir", image: "/brand/404/bateria.png", alt: "Bateria mascote num palco vazio", en: { eyebrow:"404 · After the encore", heading:"Silence on the setlist.", body:"The stage is empty. Fortunately, the listings are not.", cta:"See who plays next", alt:"Drum kit mascot on an empty stage" } },
  { eyebrow: "404 · Corda partida", heading: "Este riff ficou por tocar.", body: "A corda partiu e o evento saiu do alinhamento. Há mais música logo a seguir.", cta: "Afinar nova procura", image: "/brand/404/guitarra.png", alt: "Guitarra mascote com uma corda partida", en: { eyebrow:"404 · Broken string", heading:"This riff went unplayed.", body:"The string snapped and the event dropped off the setlist. More music is just ahead.", cta:"Tune a new search", alt:"Guitar mascot with a broken string" } }
];
