...
const features = [
  {
    ...
    caption: `O fim de semana não cabe num só palco. De 25 a 27 de setembro, estes são cinco desvios para guardar:\n\n26 SET · @boneym.official · Póvoa Arena · Póvoa de Varzim\n25–26 SET · Under The Doom Festival · @lavlisboa · Lisboa · evento de Notredame Productions\n26 SET · Reign Of Fury Fest 2026 · Ginásio Clube de Corroios · Corroios · evento de @reignfuryfest\n26 SET · Paws and Claws 9 · Heaven’s Social Club · Porto · evento de @lancachamas2026\n27 SET · @festival.guitarra.lagoa · Centro Cultural Convento de S. José · Lagoa\n\nHá muito mais a acontecer na agenda. Guarda o carrossel, envia-o a quem vai contigo e confirma horários e bilhetes na fonte de cada evento em odesvio.pt.\n\nMenos procura. Mais música.\n\n#odesvio #concertosportugal #fimdesemana #musicaaovivo #agendacultural`,
  },
  {
    ...
    events: [
      ...
      { eyebrow: "2 OUT · LAGOS", title: ["Fado &amp; Jazz", "Uma Só Alma"], titleSize: 66, details: ["Centro Cultural de Lagos", "21h00"], promoter: "VÂNIA RODRIGUES · @GABRIELFIALHOARTE", mascotY: 620, rotate: 2 },
